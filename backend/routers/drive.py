...
def get_redirect_uri():
    ...
    # Preview/development
    return "https://production-alert-1.preview.emergentagent.com/api/drive/oauth/callback"
...
async def drive_oauth_callback(
    ...
    if error:
        ...
        frontend_url = os.environ.get("REACT_APP_BACKEND_URL", "https://production-alert-1.preview.emergentagent.com")
