...
def get_redirect_uri():
    ...
    # Preview/development
    return "https://order-tracking-test.preview.emergentagent.com/api/drive/oauth/callback"
...
async def drive_oauth_callback(
    ...
    if error:
        ...
        frontend_url = os.environ.get("REACT_APP_BACKEND_URL", "https://order-tracking-test.preview.emergentagent.com")
    ...
    if not frontend_url:
        ...
        if auth_url:
            ...
            frontend_url = "https://order-tracking-test.preview.emergentagent.com"
