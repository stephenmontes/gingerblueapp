...
def get_redirect_uri():
    ...
    # Preview/development
    return "https://retail-bulk-mark.preview.emergentagent.com/api/drive/oauth/callback"
...
async def drive_oauth_callback(
    ...
    if error:
        ...
        frontend_url = os.environ.get("REACT_APP_BACKEND_URL", "https://retail-bulk-mark.preview.emergentagent.com")
    ...
    if not frontend_url:
        ...
        if auth_url:
            ...
            frontend_url = "https://retail-bulk-mark.preview.emergentagent.com"
