import { Factory, Menu, X, ShoppingCart, Clock, AlertTriangle, TrendingUp, Building2, UserPlus, FileText, Megaphone, Headphones } from "lucide-react";
...
const navItems = [
  ...
  { path: "/crm/campaigns", label: "Campaigns", icon: Megaphone },
  { path: "/crm/cases", label: "Cases", icon: Headphones },
