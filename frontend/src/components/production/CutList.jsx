...
import { Scissors, Package, Check, Loader2, Clock, ArrowRight, AlertTriangle, PackagePlus, Trash2 } from "lucide-react";
    ...
    <>
      ...
      {!isLast && (
        <TableRow className="h-2 border-0">
          <TableCell colSpan={isCuttingStage ? 7 : (isQualityCheckStage ? 7 : (nextStage ? 6 : 5))} className="p-0" />
        </TableRow>
      )}
    </>
  );
